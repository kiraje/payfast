		...
		<section class="wrap-detail-page ">
				...
				<div class="row">
					<?php
						...
						}elseif( get_theme_mod( 'archive_post_layout', 'grid' ) == 'single-overlay' ){
							$layout_class = 'single-overlay';
						}
						...
						<?php
							if( !get_theme_mod( 'disable_pagination', false ) ):
								the_posts_pagination( array(
									'next_text' => '<span>'.esc_html__( 'Next', 'bosa-consulting' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'bosa-consulting' ) . '</span>',
									'prev_text' => '<span>'.esc_html__( 'Prev', 'bosa-consulting' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'bosa-consulting' ) . '</span>',
									'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'bosa-consulting' ) . ' </span>',
								));
							endif;
						?>
					</div><!-- #primary -->
